...
def run():
	...
	with open('figures/final/figure_s6.txt', 'w') as fp:
		for line in output:
			fp.write(line+'\n')

	plot_style()
	with PdfPages('figures/final/figure_s6.pdf') as pdf:
		for page in set(specid_page.values()):
			...
			fig.suptitle(f'Figure S6 page {page+1}')
